...
resource "aws_security_group_rule" "allow-ssh-rule" {
  from_port         = 22
  protocol          = "tcp"
...
resource "aws_security_group_rule" "allow-all-ports-rule" {
  from_port         = 0
  protocol          = "-1"
...
resource "aws_security_group_rule" "allow-all-ports-egress-rule" {
  from_port         = 0
  protocol          = "-1"
  security_group_id = aws_security_group.public-sg.id
  to_port           = 0
